...
//   return (
//     <>
//       <Button className='block_end_button' as="input" type="submit" value="Oбратный звонок"/>
//     </>
//   );
// }
...
function Example() {
  ...
  return (
    <>
      <Button onClick={secondmain} as="input" type="submit" className="me-2 block_end_button" value="Oбратный звонок"/>
